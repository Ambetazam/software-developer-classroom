...
CREATE TABLE patrocinios_grupo (
  ...
  CONSTRAINT fk_patrocinios_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE equipos_torneos_grupo (
  ...
  CONSTRAINT fk_equipos_torneos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE jugadores_equipos_grupo (
  ...
  id_jugadores_equipos INT NOT NULL,
  id_grupo INT NOT NULL,
  PRIMARY KEY (id_jugadores_equipos_grupo),
  CONSTRAINT fk_jugadores_equipos_grupo_jugadores_equipos FOREIGN KEY (id_jugadores_equipos) REFERENCES jugadores_equipos(id_jugadores_equipos),
  CONSTRAINT fk_jugadores_equipos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE patrocinadores_grupo (
  ...
  CONSTRAINT fk_patrocinadores_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE servidores_grupo (
  ...
  CONSTRAINT fk_servidores_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE partidos_grupo (
  ...
  CONSTRAINT fk_partidos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE torneos_grupo (
  ...
  CONSTRAINT fk_torneos_grupo_torneos FOREIGN KEY (id_torneos) REFERENCES torneos(id_torneos),
  CONSTRAINT fk_torneos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE videojuegos_grupo (
  ...
  CONSTRAINT fk_videojuegos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
CREATE TABLE equipos_grupo (
  ...
  CONSTRAINT fk_equipos_grupo_grupo FOREIGN KEY (id_grupo) REFERENCES grupo(id_grupo)
);
...
INSERT INTO jugadores_equipos (id_jugadores_equipos) VALUES ('JE001');
INSERT INTO jugadores_equipos (id_jugadores_equipos) VALUES ('JE002');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'PTP001');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'T9');
INSERT INTO grupo (id_grupo, grupo) VALUES ('3', 'PTP002');
INSERT INTO grupo (id_grupo, grupo) VALUES ('4', 'T6');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'E001');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'T9');
INSERT INTO grupo (id_grupo, grupo) VALUES ('3', 'E002');
INSERT INTO grupo (id_grupo, grupo) VALUES ('4', 'T6');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', '001');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'E001');
INSERT INTO grupo (id_grupo, grupo) VALUES ('3', '002');
INSERT INTO grupo (id_grupo, grupo) VALUES ('4', 'E002');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'Bunueleria La Propia');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', '3005456566');
INSERT INTO grupo (id_grupo, grupo) VALUES ('3', 'lapropiabuenuelos@conqueso.adentro');
INSERT INTO grupo (id_grupo, grupo) VALUES ('4', 'Pandequesos Santarosanos');
INSERT INTO grupo (id_grupo, grupo) VALUES ('5', '3216578356');
INSERT INTO grupo (id_grupo, grupo) VALUES ('6', 'santarosadeosospandequesos@leche.oro');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'Cancha La Maracana, Castilla');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'Estadio Atanasio');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'Amistoso');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'Clasico');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'La Vuelta a la Oriental');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'Daremos de Nuevo la Vuelta a Versalles');

INSERT INTO torneos_grupo (id_torneos_grupo, id_torneos, id_grupo) VALUES ('1', 'T9', '1');
INSERT INTO torneos_grupo (id_torneos_grupo, id_torneos, id_grupo) VALUES ('2', 'T6', '2');

INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'El Ultimo de la Fila 3: Sisben Stories');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'La Ultima y nos vamos 5: Head Troubles with my wife');
...
INSERT INTO grupo (id_grupo, grupo) VALUES ('1', 'Provenza FC');
INSERT INTO grupo (id_grupo, grupo) VALUES ('2', 'provenzachampios@ladiez.po');
INSERT INTO grupo (id_grupo, grupo) VALUES ('3', '3224556677');
INSERT INTO grupo (id_grupo, grupo) VALUES ('4', 'La Milagrosa FC');
INSERT INTO grupo (id_grupo, grupo) VALUES ('5', 'virgendelamilagrosa@teamo.love');
INSERT INTO grupo (id_grupo, grupo) VALUES ('6', '3046752356');
